...
import { getInterviewsByUserId, getLatestInterviews } from "@/services/firestore";
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const [myInterviews, otherInterviews] = await Promise.all([
        ...
        if (!cancelled) {
          ...
          setLatestInterviews(otherInterviews);
        }
      } catch (error) {
